...
(function i18nFull(){
  ...
  const MAP_EN_ES = new Map([
    ...
    ["backToDealer", "Volver a Quirk Nissan Braintree"],
    ["successTitle", "¡Gracias! - Quirk Nissan Braintree"],
    ["successHeading", "¡Gracias!"],
    ["successMessage", "Hemos recibido los detalles de su intercambio. Un especialista de Quirk Nissan Braintree se pondrá en contacto con usted en breve."]
  ]);
